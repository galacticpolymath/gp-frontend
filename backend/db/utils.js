 ...
 * @param {{ _id: string, email: string, password: { hash: string, salt: string, iterations: number } | null, provider: string, roles: string[] }} documentObj The object that will be created into the mongoose model.
 * */
