...
const JobViz = ({ unitName, jobTitleAndSocCodePairs, hasGpPlusMembership }) => {
  ...
  const baseViewTitle = formatViewTitle(activeBreadcrumb?.label ?? "job categories");
  const viewingTitle = isShowingAssignmentScope ? "Assigned jobs" : baseViewTitle;
