...
export default async function handler(request, response) {
    try {
        ...
        const { wasSuccessful } = await sendEmail({
            ...
            html: createPasswordResetEmail(user.name.first, resetPasswordLink, isCredentials),
            text: `You requested to reset your password. If you didn't, please disregard this message. Please click the following link to reset it: ${resetPasswordLink}`,
        });
