  ...
  return (
    <section className='readyToInspireParentSec mt-5'>
      <div className="readyToInspireSec pt-5 d-lg-flex flex-lg-row-reverse">
        ...
        <section className="readyToInspireTxtsSec pt-md-2 pt-sm-0 pt-4 d-md-flex justify-content-md-center align-items-md-center flex-md-column">
          <section className="ps-sm-5 ps-md-0 mt-3 mt-sm-4 mt-md-2 mt-lg-0 d-flex flex-column readyInspireSec">
            ...
            <span className="fs-24 d-block fw700 d-none d-md-inline-flex justify-content-md-center align-items-md-center text-center d-lg-inline">Ready to inspire students with your work?</span>
          ...
          <section className="ps-sm-5 ps-md-0 mt-4 d-flex flex-column orderLaCarteSec">
            <span className="fs-med d-none fw249 d-sm-inline d-md-inline-flex justify-content-md-center align-items-md-center d-lg-none">Order <span className="fst-italic">à la carte</span> or customize a package.</span>
            <span className="fs-med d-none fw249 d-sm-inline d-md-inline-flex justify-content-md-center align-items-md-center d-lg-none">Let us know how we can help!</span>
