...
import styles from "./SummaryModal/JobVizSummaryModal.module.scss";
...
import {
  ...
  sanitizePlainText,
  useClipboard,
} from "./SummaryModal/jobvizSummaryUtils";
import type {
  SummaryJobRow,
  SummaryPronoun,
} from "./SummaryModal/jobvizSummaryUtils";
...
const JobVizSummaryModal: React.FC = () => {
  ...
  const jobRows = useMemo<SummaryJobRow[]>(
    () => normalizedJobs.map((job) => buildSummaryJobRow(job, activeRatings)),
