    ...
    return (
        ...
        >
            <div className="position-relative">
                ...
                {isNew && <div style={{ width: "85px", border: 'solid 1px white', fontStyle: 'italic', height: '37.6px', fontSize: '25px', fontWeight: 500, transform: 'translate(10px, -15px)' }} className="position-absolute d-flex justify-content-center align-items-center shadow top-0 end-0 bg-primary text-white text-center p-1 rounded-3">NEW</div>}            </div>
