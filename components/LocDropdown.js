...
const LocDropdown = ({ id, availLocs, loc }) => {
  ...
  return (
    <ReactFlagsSelect selected={country} countries={countries} 
      customLabels={labels} onSelect={
        countryCode => {changeLoc(countryCode, id)}
      } 
      placeholder={'Current locale: ' + loc} alignOptionsToRight={true} 
      fullWidth={false} showSelectedLabel={true} 
      showSecondarySelectedLabel={false} showOptionLabel={false} 
